        ...
        <div class="section-body mt20">
            <div class="list-info flex">
                <div class="item-body" v-for="item in baseData" :key="item.id">
                    <div class="item flex flex-justify-between flex-align-center" v-for="list in item.org" :key="list.id">
                        <div class="item-hd">机构：</div>
                        <div class="item-ft">{{list.orgDesc}}</div>
                    </div>
